...
import { ThumbsUp, Tv, PlaneTakeoff } from 'lucide-react';
...
export function RecommendationsSection({ costSaving, ottRecommendation, travelRecommendation }: RecommendationsSectionProps) {
  const hasAnyRecommendation = costSaving || ottRecommendation || travelRecommendation;

  return (
    <Card className="shadow-lg">
      <CardHeader>
        <CardTitle className="text-2xl font-semibold text-primary">Smart Recommendations For You</CardTitle>
        <CardDescription>Plans and packs tailored to your usage and lifestyle.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-8">
        {!hasAnyRecommendation && (
          <p className="text-md text-muted-foreground text-center py-8">
            No specific recommendations for you at the moment. Check back later!
          </p>
        )}
        ...
        {costSaving && (
          <div className="space-y-3">
            ...
            <PersonalizedPlanCard plan={costSaving.recommendedPlan} ctaText="View Plan & Save" />
          </div>
        )}
        ...
        {ottRecommendation && (
          <div className="space-y-3">
            ...
            <PersonalizedPlanCard plan={ottRecommendation.recommendedPlan} ctaText="View Plan & Binge" />
          </div>
        )}
        ...
        {travelRecommendation && (
          <div className="space-y-3">
            ...
            <PersonalizedPlanCard plan={travelRecommendation.recommendedPack} ctaText="View Roaming Pack" />
          </div>
        )}
      </CardContent>
    </Card>
